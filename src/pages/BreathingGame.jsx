...
export default function BreathingGame({ onBack }) {
  ...
  const phaseColor =
    phaseIndex === 0 ? theme.accent : phaseIndex === 1 ? theme.warning : theme.success;
    ...
    <div style={{ animation: "fadeIn 0.4s ease" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            inset: "-20px",
            borderRadius: "50%",
            background: `radial-gradient(circle, ${phaseColor}15 0%, transparent 70%)`,
              ...
              <div
                ...
                style={{
                  ...
                  background: i === phaseIndex
                    ? isDark ? `${phaseColor}25` : `${phaseColor}15`
                    : "transparent",
        ...
        {!isActive ? (
          ...
          <button
            ...
            style={{
              ...
              color: theme.danger, fontSize: "15px", fontWeight: 700, cursor: "pointer",
              transition: "all 0.3s ease",
            }}
          >
            Pause ⏸
        ...
        {(cycles > 0 || totalTime > 0) && (
          <button
            ...
            style={{
              ...
              color: theme.textSecondary, fontSize: "15px", fontWeight: 600, cursor: "pointer",
              backdropFilter: isDark ? "none" : theme.glassBlur,
            }}
          >
            Reset 🔄
      ...
      {cycles > 0 && !isActive && (
        <div style={{
          ...
          <p style={{ color: theme.accent, fontSize: "24px", fontWeight: 800 }}>
            Score: {calcScore()} 🏆
          </p>
