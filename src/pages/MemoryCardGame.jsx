    ...
    <div style={{ animation: "fadeIn 0.4s ease" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
        <div>
          ...
          <p style={{ color: theme.textMuted, fontSize: "13px", margin: "4px 0 0" }}>
            Match all pairs to sharpen your focus
          </p>
        </div>
        <button
          onClick={restart}
      ...
      <div style={{
        ...
        {cards.map((card, i) => (
          <div
            ...
            style={{
              ...cardStyle(card),
              animation: card.matched ? "bounceIn 0.4s ease" : `scaleIn 0.3s ease ${i * 0.03}s both`,
            }}
          >
      ...
      {gameOver && (
        <div style={{
          ...
          <h3 style={{ color: theme.success, fontSize: "22px", fontWeight: 800, margin: "0 0 8px" }}>
            Congratulations!
          </h3>
          <p style={{ color: theme.textSecondary, fontSize: "14px", marginBottom: "4px" }}>
            Completed in {moves} moves and {timer} seconds
          </p>
          <p style={{ color: theme.accent, fontSize: "28px", fontWeight: 800, margin: "12px 0" }}>
            Score: {calcScore()}
          </p>
          <button
            onClick={restart}
