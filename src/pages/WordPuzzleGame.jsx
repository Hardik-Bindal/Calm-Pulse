        ...
        <div>
          <button
            ...
            style={{
              ...
              fontSize: "14px", cursor: "pointer", padding: 0, marginBottom: "8px",
              fontWeight: 600,
            }}
          >
            ← Back to Games
          </button>
          <h2 style={{ color: theme.textPrimary, fontSize: "22px", fontWeight: 800, margin: 0 }}>
            🔤 Word Puzzle
          </h2>
          <p style={{ color: theme.textMuted, fontSize: "13px", margin: "4px 0 0" }}>
            Unscramble calming words to relax your mind
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        {!isActive && round === 0 ? (
          ...
          <div style={{ animation: "fadeIn 0.4s ease" }}>
            ...
            <h3 style={{ color: theme.textPrimary, fontSize: "20px", fontWeight: 700, marginBottom: "8px" }}>
              Ready to unscramble?
            </h3>
          ...
          <div style={{ width: "100%", maxWidth: "400px", animation: "fadeIn 0.3s ease" }}>
            ...
            <div style={{
              ...
              background: theme.barBg, marginBottom: "28px", overflow: "hidden",
            }}>
              <div style={{
                width: `${timerPercent}%`,
                height: "100%",
            ...
            <div style={{ color: timerColor, fontSize: "14px", fontWeight: 700, marginBottom: "8px" }}>
              ⏱️ {timer}s remaining
            </div>
            ...
            <p style={{ color: theme.textDim, fontSize: "12px", marginBottom: "16px" }}>
              {wordLength} letters • Type the word below
            </p>
          ...
          <div style={{ animation: feedback?.correct ? "bounceIn 0.5s ease" : "fadeIn 0.3s ease" }}>
            ...
            <h3 style={{
              ...
              fontSize: "20px", fontWeight: 800, marginBottom: "8px",
            }}>
              {feedback?.correct ? "Correct!" : feedback?.timedOut ? "Time's Up!" : "Not Quite!"}
            </h3>
            {feedback?.answer && (
              <p style={{ color: theme.textSecondary, fontSize: "15px", marginBottom: "4px" }}>
                The word was: <strong style={{ color: theme.accent }}>{feedback.answer}</strong>
              </p>
            )}
            {feedback?.correct && (
              <p style={{ color: theme.accent, fontSize: "22px", fontWeight: 800, margin: "12px 0" }}>
